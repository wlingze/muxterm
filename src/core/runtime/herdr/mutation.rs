...
use crate::protocol::state::{MutationKind, MutationResult, MutationStage};
...
pub struct PendingMutation {
    ...
    /// NewTab / SplitPane 的工作目录；None = Runtime 默认。
    pub workdir: Option<String>,
    /// SplitPane 的方向。
    pub split_dir: Option<crate::protocol::layout::SplitDir>,
