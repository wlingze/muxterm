...
use crate::core::config::parse_command_argv;
use crate::core::protocol::state::{MutationKind, MutationResult, State, StateChange};
...
use crate::core::workspace::template::{
    PaneTemplate, TemplateLayout, TemplateName, WorkspaceTemplate,
};
...
mod tests {
    ...
    fn split_template() -> WorkspaceTemplate {
        WorkspaceTemplate {
            ...
            tabs: vec![crate::core::workspace::template::TabTemplate {
                name: None,
                active: true,
    ...
    fn accepted_new_tab_waits_for_tab_pane_and_settlement() {
        ...
        let template = WorkspaceTemplate {
            ...
            tabs: vec![
                crate::core::workspace::template::TabTemplate {
                    name: None,
                    active: true,
                    layout: leaf(),
                },
