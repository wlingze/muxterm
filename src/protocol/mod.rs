...
//!
//! 本模块是 Core Protocol 的门面（facade），re-export `protocol::model` 中的
...
pub use crate::protocol::model::layout;
#[allow(unused_imports)]
pub use crate::protocol::model::state;
#[allow(unused_imports)]
pub use crate::protocol::model::task;
