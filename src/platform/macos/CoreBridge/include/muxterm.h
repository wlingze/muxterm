...
int muxterm_workspace_send_input(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, const uint8_t* data, size_t len);
...
int muxterm_workspace_resize_client(struct MuxtermHandle* h, const char* workspace_id, uint16_t cols, uint16_t rows);
...
int muxterm_workspace_resize_pane_axis(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint32_t axis, uint16_t size);
...
int muxterm_workspace_pane_scroll_ansi(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint32_t offset, uint32_t rows, uint8_t* buf, size_t buf_len);
int muxterm_workspace_pane_visible_ansi(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint8_t* buf, size_t buf_len);
int muxterm_workspace_pane_surface_seed_ansi(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint8_t* buf, size_t buf_len);
int muxterm_workspace_pane_viewport(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id);
int muxterm_workspace_set_pane_viewport(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint32_t offset);
int muxterm_workspace_pane_history_max_offset(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint32_t rows);
char* muxterm_workspace_pane_command_marks_json(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id);
int64_t muxterm_workspace_pane_latest_line_seq(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id);
int muxterm_workspace_pane_viewport_for_seq(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint64_t seq);
char* muxterm_workspace_pane_last_n_lines(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint32_t n);

int muxterm_workspace_attention_on_became_visible(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id);
int muxterm_workspace_attention_acknowledge(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id);
int muxterm_workspace_attention_set_process_name(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, const char* name);
int muxterm_workspace_attention_mute(struct MuxtermHandle* h, const char* workspace_id, uint32_t pane_id, uint64_t seconds);
