...
mod tests {
    ...
    fn store_round_trips_documents_without_rebuilding_them() {
        ...
        document.worktrees.push(
            crate::frontend::linux::quickconnect::model::WorktreeDocument {
                id: "feature".into(),
    ...
    fn invalid_project_document_survives_store_round_trip_but_is_not_a_row() {
        let invalid = ProjectDocument {
            ...
            name: "broken".into(),
            path: "~/broken".into(),
            runtime: crate::frontend::linux::quickconnect::model::ProjectRuntime {
            ...
            transport: crate::frontend::linux::quickconnect::model::ProjectTransport {
                id: "local".into(),
                target: String::new(),
                options: Default::default(),
            },
