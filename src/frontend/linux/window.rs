...
use crate::frontend::ffi_client::{
    ...
    ClientLayout, ClientOpenIntent, ClientOpenRequest, ClientRuntimeCapability, ClientRuntimeInfo,
    ClientTarget, ClientTask, ClientWorkspaceEvent, FfiClient,
};
...
use self::window_event_pump::{activity_snapshot, enqueue_workspace_input, sync_view_store};
