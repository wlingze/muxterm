...
fn draw_status_bar(buf: &mut Buffer, area: Rect, snap: &FrameSnapshot, theme: &Theme) {
    ...
    let status_key = match snap.status.as_str() {
        "connected" => crate::frontend::utils::i18n::Key::StatusConnected,
        "connecting" => crate::frontend::utils::i18n::Key::StatusConnecting,
        "disconnected" => crate::frontend::utils::i18n::Key::StatusDisconnected,
        "error" => crate::frontend::utils::i18n::Key::StatusError,
        "exited" => crate::frontend::utils::i18n::Key::StatusExited,
        _ => crate::frontend::utils::i18n::Key::StatusUnknown,
    };
    let status = crate::frontend::utils::i18n::tr(status_key);
    let panes = crate::frontend::utils::i18n::tr(crate::frontend::utils::i18n::Key::Panes);
    let palette = crate::frontend::utils::i18n::tr(crate::frontend::utils::i18n::Key::HintPalette);
    let new_tab = crate::frontend::utils::i18n::tr(crate::frontend::utils::i18n::Key::HintNewTab);
    let split = crate::frontend::utils::i18n::tr(crate::frontend::utils::i18n::Key::HintSplit);
    let vertical_split =
        crate::frontend::utils::i18n::tr(crate::frontend::utils::i18n::Key::HintVerticalSplit);
    let pane = crate::frontend::utils::i18n::tr(crate::frontend::utils::i18n::Key::HintPane);
    let quit = crate::frontend::utils::i18n::tr(crate::frontend::utils::i18n::Key::HintQuit);
    let hint = format!(
...
mod tests {
    ...
    fn render_has_status_bar() {
        let buf = render(&snap_single_pane(), None, RenderOpts::default());
        let s = buf_to_string(&buf);
        assert!(s.contains(&crate::frontend::utils::i18n::tr(
            crate::frontend::utils::i18n::Key::StatusConnected
        )));
    ...
    fn render_status_bar_shows_exited_status() {
        ...
        let s = buf_to_string(&buf);
        assert!(s.contains(&crate::frontend::utils::i18n::tr(
            crate::frontend::utils::i18n::Key::StatusExited
        )));
    }
