...
impl PaneBuf {
    ...
    /// OSC 133 命令刻度（W18h）。
    pub fn command_marks(&self) -> &[crate::protocol::terminal::emulate::CommandMark] {
    ...
    pub fn last_failed_command(&self) -> Option<&crate::protocol::terminal::emulate::CommandMark> {
