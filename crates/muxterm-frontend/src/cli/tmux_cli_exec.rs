...
impl FfiTmuxClient {
    ...
    fn tabs(&self) -> Vec<crate::ffi_client::ClientTab> {
        self.client.get_workspace_tabs(&self.workspace_id)
    }

    fn panes(&self, tab_id: u32) -> Vec<crate::ffi_client::ClientPane> {
        self.client.get_workspace_panes(&self.workspace_id, tab_id)
    }

    fn active_tab(&self) -> Option<crate::ffi_client::ClientTab> {
