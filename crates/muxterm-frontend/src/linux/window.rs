...
use crate::linux::app_shell::{AppShell, HeaderActions};
use crate::linux::attention_compat::CompatibilityActivity;
use crate::linux::attention_ui::{GioSink, NotificationSink};
use crate::linux::command_palette::{parse_palette_action, PaletteAction};
#[cfg(test)]
use crate::linux::event_batch::batch_order_plan;
use crate::linux::keymap::{default_keybindings, Action, KeyMap};
use crate::linux::layout_host::LayoutHost;
use crate::linux::lifecycle::{should_close_window, OnLastPaneExit};
use crate::linux::overlay::OverlayLayer;
use crate::linux::pane_view::{PaneMenuAction, PaneSurface};
use crate::linux::panel_model::PanelTab;
use crate::linux::quickconnect::existing::ExistingEntry;
use crate::linux::quickconnect::font::FontSettings;
use crate::linux::quickconnect::status_style::StatusBarMode;
use crate::linux::quickconnect::store::QuickConnectStore;
use crate::linux::quickconnect_panel::{
...
use crate::linux::theme::{fallback_theme, toggle_target, Theme};
use crate::linux::view_store::ViewStore;
use crate::linux::window_input::{connect_close_handler, connect_key_handler};
use crate::linux::workspace_scenes::WorkspaceScenes;
...
impl AppWindow {
    ...
    pub fn shutdown(self) {
        crate::linux::quickconnect_panel::clear_panel_hooks();
        {
...
fn resident_pane_view(
    ...
    wid: &WorkspaceId,
    pane: u32,
) -> Option<std::rc::Rc<crate::linux::pane_view::PaneSurface>> {
    s.scenes
        .get(wid)
