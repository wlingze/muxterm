...
#[cfg(test)]
use crate::ffi_client::FfiClient;
use crate::ffi_client::{ClientConfigSnapshot, ClientJsonPatchOperation, ClientRuntimeInfo};
pub use crate::linux::settings_model::ConfigApi;
#[cfg(test)]
use gtk4::SpinButton;
...
pub fn show(
    ...
    project_editor: Option<(Vec<ClientRuntimeInfo>, Vec<crate::ffi_client::SshHostEntry>)>,
) -> Window {
...
fn show_project_manager(
    ...
    hosts: Vec<crate::ffi_client::SshHostEntry>,
