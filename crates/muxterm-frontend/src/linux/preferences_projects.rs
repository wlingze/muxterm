...
use crate::ffi_client::{ClientConfigSnapshot, ClientRuntimeInfo, SshHostEntry};
use crate::linux::quickconnect::model::ProjectDocument;
        ...
        move || {
            ...
            for project in &projects {
                ...
                edit.connect_clicked(move |_| {
                    ...
                    crate::linux::target_config_window::show(
                        &win,
                        Some(target),
                        store.borrow().clone(),
                        hosts.clone(),
