//! 目标配置窗口 GTK view/controller：runtime / transport / SSH alias / path / name。
//!
...
use crate::ffi_client::{ClientRuntimeInfo, FfiClient, SshHostEntry};
use crate::i18n::{self, Key};
use crate::linux::quickconnect::directory::{
