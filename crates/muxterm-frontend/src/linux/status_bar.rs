...
use crate::linux::lifecycle::tab_shortcut_label;
use crate::linux::quickconnect::status_style::{
...
fn bg_to_hex(c: crate::linux::quickconnect::status_style::StatusBarColor) -> String {
    format!(
        "{:02x}{:02x}{:02x}",
...
fn fg_to_hex(c: crate::linux::quickconnect::status_style::StatusBarColor) -> String {
    bg_to_hex(c)
}

/// 把带样式的片段渲染成 Pango markup。
fn styled_markup(
    segments: &[crate::linux::quickconnect::status_style::StatusBarStyledSegment],
    plain_fg: Option<&str>,
) -> String {
...
pub fn test_snapshot(enabled: bool) -> StatusBarSnapshot {
    StatusBarSnapshot {
        ...
        windows: vec![
            crate::linux::quickconnect::status_style::StatusBarWindow {
                window_id: 0,
                index: 1,
                name: "bash".into(),
                flags: "*".into(),
...
mod tests {
    ...
    fn styled_markup_escapes_and_applies_style() {
        let segments = vec![
            crate::linux::quickconnect::status_style::StatusBarStyledSegment {
                text: "<b>&".into(),
                style: crate::linux::quickconnect::status_style::StatusBarTextStyle {
                    fg: Some(crate::linux::quickconnect::status_style::StatusBarColor {
                        red: 1.0,
                        green: 0.0,
                        blue: 0.0,
                    }),
        ...
        let segments = vec![
            crate::linux::quickconnect::status_style::StatusBarStyledSegment {
                ...
                style: crate::linux::quickconnect::status_style::StatusBarTextStyle {
                    ...
                    bg: Some(crate::linux::quickconnect::status_style::StatusBarColor {
                        red: 0.0,
                        green: 0.0,
                        blue: 1.0,
                    }),
    ...
    fn color_hex_conversion_rounds_to_bytes() {
        assert_eq!(
            bg_to_hex(crate::linux::quickconnect::status_style::StatusBarColor {
                red: 1.0,
                green: 0.5,
                blue: 0.0,
            }),
        ...
        assert_eq!(
            fg_to_hex(crate::linux::quickconnect::status_style::StatusBarColor {
                red: 0.0,
                green: 0.0,
                blue: 1.0,
            }),
