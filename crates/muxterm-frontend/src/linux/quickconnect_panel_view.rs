...
use crate::linux::panel_model::AttentionPanelRow;
...
use crate::linux::workspace_sidebar::ActivityIndicator;
use crate::ssh_probe::{ssh_dot_css_class, ssh_dot_widget_name, SshReach};
...
pub(super) fn ensure_overlay(parent: &Window) -> Overlay {
    crate::linux::quick_pick::ensure_overlay(parent)
}
